...
const Hero = () => {
  return (
    <div style={{backgroundImage: `url(${banner})`}} className='relative bg-cover bg-center  text-white 2xl:min-h-[80vh] min-h-screen'>
    ...
    <div className='relative p-10 lg:p-20 2xl:p-48 2xl:min-h-[80vh] z-[10] flex flex-col items-center justify-center lg:flex-row lg:justify-around lg:items-center min-h-full'>
        ...
        {/* Hero content */}
        <div data-aos="fade-right"  className=' w-full lg:w-[500px] xl:flex-1  mb-10 flex md:w-[80%] items-center flex-col gap-6'>
            ...
            <div className='mt-5 flex flex-col sm:flex-row gap-4'>
                < Link to={"/contact-us"} className='  py-3 px-8 ease-in duration-200 hover:bg-transparent border border-blue-700 rounded-sm bg-blue-700 text-white'
                >Get started</Link>
   ...
   {/* Shape devider */}
    <div className="custom-shape-divider-bottom-1717760727 -mb-[2px]"  >
